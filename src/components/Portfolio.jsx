          ...
          <div className="lg:min-w-[400px] min-h-[200px] p-5 overflow-hidden " data-aos-once="true" data-aos="zoom-in" data-aos-delay="300">
            <div className="w-96 mx-auto bg-slate-600 rounded-xl relative group ">
              ...
              <img
                src={onlineShop}
                alt="online shop"
                className="mx-auto transition duration-500 ease-in-out w-96 rounded-xl group-hover:blur-[2px] h-56"
              />
              <h1 className="text-xl font-bold text-white text-center font-serif mt-2 mb-3 ">
                Project Online Shop dengan autentikasi dengam menggunakan mvc,auth,middleware di laravel
              </h1>
              <a href="https://github.com/dvnn-star/Delvinshop" className="absolute top-1/3 right-1/3 text-white font-mono text-xl bg-black p-1 rounded-md opacity-0 group-hover:opacity-[1] transition-opacity duration-500">
                Github Repo
              </a>
              <div className="absolute flex  scale-[2.5] left-10 bottom-[100px] opacity-0 group-hover:opacity-[1] transition-opacity duration-500">
                <FaLaravel color="red"/>
              </div>
            </div>
          </div>
