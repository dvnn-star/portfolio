      ...
      <div className="flex mt-4 justify-between">
        ...
        <div className="flex items-center gap-7 px-5" data-aos="fade-left" data-aos-delay="300">
          <a href="https://github.com/dvnn-star" >
            <BsGithub className="scale-[2] text-white" href="https://github.com/dvnn-star" />
          </a>
          <a href="https://www.instagram.com/dvn_delvin/" target="_blank" rel="noopener noreferrer" className="p-4">
